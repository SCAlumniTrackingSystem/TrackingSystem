...
INNER JOIN batch on gradlist_tbl.batchID = batch.batchID WHERE batch.batchID = '1' AND courses.courseID = '7'
...
<script>
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'Employment Status of BSED 2020'
        },
        tooltip: {
...
INNER JOIN gradlist_tbl on registration.grad_ID = gradlist_tbl.grad_ID
INNER JOIN courses on gradlist_tbl.courseID = courses.courseID 
INNER JOIN batch on gradlist_tbl.batchID = batch.batchID WHERE batch.batchID = '2' AND courses.courseID = '7'
 GROUP BY emID"; // get the records on which pie chart is to be drawn
$getData = $con->query($query);
?>
<script>
    ...
    Highcharts.chart('container1', {
        ...
        title: {
            text: 'Employment Status of BSED 2021'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
<script>
    ...
    Highcharts.chart('container2', {
        ...
        title: {
            text: 'Job Alignment of BSED 2020'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
<script>
    ...
    Highcharts.chart('container3', {
        ...
        title: {
            text: 'Job Alignment of BSED 2021'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
