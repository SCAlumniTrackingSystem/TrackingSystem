  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="add_dep-code.php">
...
<!-- Modal update -->
<div class="modal fade" id="update" tabindex="0" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="updatecode.php">
        	...
        	<div class="form-group">
        		<label>Department</label>
        		<input type="text" id="upd" class="form-control" name="dept" required="">
        	</div>
        ...
        while($row = mysqli_fetch_array($query_run)){
            ...
            echo '
                ...
                <tr >
          		 ...
          		 <td style="display:none;"> '.$row["deptID"].'</td>
                <td> '.$row["dept"].'</td>
