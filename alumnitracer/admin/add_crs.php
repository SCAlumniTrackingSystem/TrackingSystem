  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="add_crs-code.php">
        	<div class="form-group">
        		<label>Course</label>
        		<input type="text" class="form-control" name="crs" required="">
        	</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="updatecrs.php">
        	<input type="hidden" name="id" id="course_id">
        	<div class="form-group">
        		<label>Course</label>
        		<input type="text" id="idcourse" class="form-control" name="crs" required="">
        	</div>
        ...
        while($row = mysqli_fetch_array($query_run)){
            ...
            echo '
                ...
                <tr >
          		 ...
          		 <td style="display:none;"> '.$row["courseID"].'</td>
                <td> '.$row["course"].'</td>
                <td>  <button type="button"class="btn btn-sm btn-outline-primary editbtn">
